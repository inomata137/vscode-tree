export const theme = [
  ...
  [
    ...
    'rgba(88, 110, 117, 0.67)'
  ],
  ['--vscode-inlineEdit-gutterIndicator.background', 'rgba(95, 95, 95, 0.09)'],
  ['--vscode-inlineEdit-gutterIndicator.primaryBackground', '#ac9d57'],
