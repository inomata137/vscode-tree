export const theme = [
  ...
  ['--vscode-chart-axis', '#6fc3df'],
  ['--vscode-chart-guide', '#6fc3df'],
  ...
  ['--vscode-editorActionList-background', '#0c141f'],
  ['--vscode-editorActionList-foreground', '#ffffff'],
  ...
  ['--vscode-inlineEdit-modifiedBorder', '#6fc3df'],
  ['--vscode-inlineEdit-originalBackground', 'rgba(0, 0, 0, 0)'],
  ['--vscode-inlineEdit-originalBorder', '#6fc3df'],
  ...
  ['--vscode-multiDiffEditor-background', '#000000'],
  ...
  ['--vscode-panelTitle-border', '#6fc3df'],
  ...
  ['--vscode-remoteHub-decorations.addedForegroundColor', '#1b5225'],
  ['--vscode-remoteHub-decorations.conflictForegroundColor', '#c74e39'],
  ['--vscode-remoteHub-decorations.deletedForegroundColor', '#c74e39'],
  ['--vscode-remoteHub-decorations.ignoredResourceForeground', '#a7a8a9'],
  ['--vscode-remoteHub-decorations.incomingAddedForegroundColor', '#1b5225'],
  ...
  ['--vscode-scmGraph-historyItemHoverDefaultLabelBackground', '#000000'],
  ['--vscode-scmGraph-historyItemHoverDefaultLabelForeground', '#ffffff'],
  ...
  ['--vscode-sideBarTitle-border', '#6fc3df'],
  ...
  ['--vscode-terminalCommandGuide-foreground', '#6fc3df'],
