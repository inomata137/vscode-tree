export const theme = [
  ...
  ['--vscode-chart-axis', '#0f4a85'],
  ['--vscode-chart-guide', '#0f4a85'],
  ...
  ['--vscode-editorActionList-focusBackground', 'rgba(15, 74, 133, 0.1)'],
  ['--vscode-editorActionList-foreground', '#292929'],
  ...
  ['--vscode-editorBracketHighlight-unexpectedBracket.foreground', '#b5200d'],
  ...
  ['--vscode-inlineEdit-gutterIndicator.primaryBackground', '#0f4a85'],
  ['--vscode-inlineEdit-gutterIndicator.primaryForeground', '#ffffff'],
  ['--vscode-inlineEdit-gutterIndicator.secondaryBackground', '#ffffff'],
  ['--vscode-inlineEdit-gutterIndicator.secondaryForeground', '#292929'],
  ['--vscode-inlineEdit-gutterIndicator.successfulBackground', '#2e825c'],
  ['--vscode-inlineEdit-gutterIndicator.successfulForeground', '#ffffff'],
  ['--vscode-inlineEdit-indicator.background', '#0f4a85'],
  ['--vscode-inlineEdit-indicator.border', 'rgba(255, 255, 255, 0.4)'],
  ['--vscode-inlineEdit-indicator.foreground', '#ffffff'],
  ['--vscode-inlineEdit-modifiedBackground', 'rgba(0, 0, 0, 0)'],
  ['--vscode-inlineEdit-modifiedBorder', '#0f4a85'],
  ['--vscode-inlineEdit-originalBackground', 'rgba(0, 0, 0, 0)'],
  ['--vscode-inlineEdit-originalBorder', '#0f4a85'],
  ...
  ['--vscode-panelTitle-border', '#0f4a85'],
  ...
  ['--vscode-remoteHub-decorations.addedForegroundColor', '#374e06'],
  ...
  ['--vscode-remoteHub-decorations.incomingAddedForegroundColor', '#374e06'],
  ...
  ['--vscode-scmGraph-historyItemHoverDefaultLabelBackground', '#0f4a85'],
  ['--vscode-scmGraph-historyItemHoverDefaultLabelForeground', '#292929'],
  ...
  ['--vscode-sideBarTitle-border', '#0f4a85'],
  ...
  ['--vscode-terminalCommandGuide-foreground', '#0f4a85'],
